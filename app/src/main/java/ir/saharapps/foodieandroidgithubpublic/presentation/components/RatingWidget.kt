package ir.saharapps.foodieapp.presentation.components
...
import ir.saharapps.foodieapp.presentation.ui.theme.StarColor
...
fun calculateStars(rating: Double): Map<String, Int> {
    ...
    println("***************** $filledStars, $halfFilledStars, $emptyStars")
    return mapOf(
